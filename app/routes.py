...
def addfile():
    ...
    if upfile.validate_on_submit():
        ...
        add_attribs = Attributes(strength=scan.seeker('Strength'),
                                 dexterity=scan.seeker('Dexterity'),
                                 stamina=scan.seeker('Stamina'),
                                 charisma=scan.seeker('Charisma'),
                                 manipulation=scan.seeker('Manipulation'),
                                 appearance=scan.seeker('Appearance'),
                                 perception=scan.seeker('Perception'),
                                 intelligence=scan.seeker('Intelligence'),
